...
#define finalfilename "image_out6med.yuv" //output file name define
...
///////////////////////////////////////////////////////////////////////////////////
       for( i=0;i<112;i++){ //14.. 28.. 56.. 112
          temp2[i][i]=padded_image[i][i];
	...
	//////////////////////////////////////////////////////
          for( i=0;i<200;i++){ //25.. 50.. 100.. 200
          temp3[i][i]=conv_out[i][i];
      }  
